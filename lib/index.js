...
var Instapaper = (module.exports = function Instapaper(
  consumerKey,
  consumerSecret,
  opts
) {
...
Bookmarks.prototype.add = function(body, callback) {
  return this.client.request('/bookmarks/add', body || {}, callback)
}
...
Folders.prototype.list = function(callback) {
  return this.client.request('/folders/list', callback)
}
...
Folders.prototype.delete = function(folder_id, callback) {
  return this.client.request('/folders/delete', { folder_id }, callback)
}
